...
-   [Deutch Quantum theory as universal physical theory.pdf](#dtchqntmthrysnvrslphysclthrypdf) [[read]] [[quantum]]
    -   [](#199_701) 
    -   [page 7, kinematically independent subsystems](#pgknmtcllyndpndntsbsystms) 
        -   [weaker condition, 'dynamical independence' , necessary and sufficient to ensure that a kinematically independent state remains so:](#wkrcndtndynmclndpndncncsshtknmtcllyndpndntsttrmnss) 
    -   [so, state is constant, and only changed during measurements?? collapse interpretation](#ssttscnstntndnlychngddrngmsrmntscllpsntrprttn) 
    -   [but MW is not without its own problems namely the problem of prefered basis and the problem of probability.](#btmwsntwthttswnprblmsnmlyprfrdbssndthprblmfprbblty) 
    -   [Everet formalism](#vrtfrmlsm) 
        -   [x](#x) 
        -   [x](#x) 
    -   [Right; I guess I have to read more on many world problematic. Maybe I shouldn't care at all and study something more practical like visualizing, simulations and solving?](#rghtgsshvtrdmrnmnywrldprbctcllkvslzngsmltnsndslvng) 





# Deutch Quantum theory as universal physical theory.pdf      [[read]] [[quantum]]
...
sufficient condition is that the Hamiltonian H is a sum of H<sub>1</sub> + H<sub>2</sub>, confined to the subsystems  
